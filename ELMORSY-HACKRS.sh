...
sleep 1
echo ""
echo -e $yellow"[*] Thanks For Using ELMORSY-HACKRS  :)"
exit
}
ppppp () {
...
sms () {
rm -rif $HOME/ELMORSY-HACKRS/sms.py
touch $HOME/ELMORSY-HACKRS/sms.py
echo 'from twilio.rest import Client' >> $HOME/ELMORSY-HACKRS/sms.py
#echo 'account_sid = 'ACe5063b7f526514972e285c82fda368cd'' >> $HOME/Building-Distro/sms.py
echo "account_sid = 'ACe5063b7f526514972e285c82fda368cd'" >> $HOME/ELMORSY-HACKRS/sms.py
echo "auth_token = '7a4462ded5843d79bf8f8778e00e2a44'" >> $HOME/ELMORSY-HACKRS/sms.py
echo "client = Client(account_sid, auth_token)" >> $HOME/ELMORSY-HACKRS/sms.py
#echo 'auth_token = '7a4462ded5843d79bf8f8778e00e2a44'' >> $HOME/Building-Distro/sms.py
echo 'message = client.messages \' >> $HOME/ELMORSY-HACKRS/sms.py
echo '.create(' >> $HOME/ELMORSY-HACKRS/sms.py
read -p "insert Your msg to Devloper ex : 'Hello Dev.ELMORSY', " msg
echo "body="$msg >> $HOME/ELMORSY-HACKRS/sms.py
echo "messaging_service_sid='MGf4e12105f858b9d74dac6cd288789c31'," >> $HOME/ELMORSY-HACKRS/sms.py
echo "from_='+12054305330'," >> $HOME/ELMORSY-HACKRS/sms.py
echo "status_callback='http://postb.in/1234abcd'," >> $HOME/ELMORSY-HACKRS/sms.py
echo "to='+967733014747'," >> $HOME/ELMORSY-HACKRS/sms.py
echo ')' >> $HOME/ELMORSY-HACKRS/sms.py
echo 'print(message.sid)' >> $HOME/ELMORSY-HACKRS/sms.py
python $HOME/ELMORSY-HACKRS/sms.py
...
echo ''
echo ''
toilet -f term -F border --gay "fb : www.fb.com/AS7ABELMGRA "
sleep 0.3
echo -e $red
#figlet -f smmono9 "ELMORSY-HACKRS" 
bash T
sleep 0.5
echo -e $red
echo -e $green"-------------------------------------------"
...
echo -e $green
#oilet -fecho -e $red
#iglet -f smmono9 "ELMORSY-HACKRS"nn
#sleep 0.3
...
if [ $name = 7 ]
then
hash -r && wget https://raw.githubusercontent.com/AS7ABELMGRA/ELMORSY-HACKRS/master/ELMORSY-HACKRS.sh
fi
if [ $name = 1 ]
then 
clear
...
echo ""
echo -e $green "insert path and name Your tool ex: Desktop/ELMORSY-HACKRS/ELMORSY-HACKRS.sh"
echo ""
echo -e $white '~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~'
...
echo -e $white '~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~'
echo ""
echo -e $green "insert path export or to export ex: Download/ELMORSY-HACKRS.sh"
echo ""
echo -e $white '~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~_~'
...
clear
head
echo -e $red   "      Update ELMORSY-HACKRS "
echo ""
rm -rif ELMORSY-HACKRS.sh
hash -r && wget https://raw.githubusercontent.com/profionaldhim/ELMORSY-HACKRS/master/ELMORSY-HACKRS.sh
echo -e $green "00- Back"
echo ""
read -p " insert : " about
if [ $about = 00 ]
...
echo ""
echo ""
figlet "ELMORSY GOOD PAY "
figlet -f circle "Exit"
echo -e $green "my channel on youtube"
echo -e"https://youtube.com/channel/UCVkTEKMwQqxGvDseHID4I9g"
